...
**Arch Clash** 是基于 **GPL-3.0** 的 **Mihomo（Clash Meta）** 图形客户端。本仓库提供 **Wails** 桌面应用（`apps/arch-clash-desktop`）。Windows **系统服务 / IPC** 在独立仓库维护：[arch-clash-service-ipc](https://github.com/Nemu-x/arch-clash-service-ipc)（构建时由 `pnpm run prebuild` 拉取发行文件）。
...
本应用发布：[ArchClash releases](https://github.com/Nemu-x/ArchClash/releases)。  
...
Arch Clash 免费且遵循 **GPL-3.0**。如果它对你有帮助，加密货币捐赠能让开发与发布持续下去。谢谢！🦥
