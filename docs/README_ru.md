...
Релизы приложения: [ArchClash releases](https://github.com/archsueh/archclash/releases).  
...
ArchClash бесплатен и распространяется под **GPL-3.0**. Если он вам полезен — крипто-донат помогает продолжать разработку и выпускать релизы. Спасибо! 🦥
